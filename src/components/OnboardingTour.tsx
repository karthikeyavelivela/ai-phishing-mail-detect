...
const tourSteps: TourStep[] = [
  {
    title: 'Welcome to Phishing Detector!',
    description: 'Learn how to protect yourself from phishing attacks with our intelligent analysis tool.',
    icon: Sparkles
  },
  {
    title: 'Quick Analysis',
    description: 'Paste any suspicious email and press Ctrl+Enter to analyze. Real-time scoring shows threats as you type!',
    icon: Sparkles
  },
  {
    title: 'Keyboard Shortcuts',
    description: 'Press ? to see all shortcuts. Use H for history, Q for quiz, S for stats, and Esc to reset.',
    icon: Sparkles
  },
  {
